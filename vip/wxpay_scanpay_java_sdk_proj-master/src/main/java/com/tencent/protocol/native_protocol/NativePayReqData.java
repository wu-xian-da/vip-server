package com.tencent.protocol.native_protocol;
...
public class NativePayReqData {
    ...
    private String trade_type = "NATIVE";//交易类型 是
     ...
     */
    public NativePayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,
    		String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,
    		String detail,String notifyUrl,String tradeType,String productId,String limitPay,String openId){

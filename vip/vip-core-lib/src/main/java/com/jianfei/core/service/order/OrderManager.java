...
public interface OrderManager {
	 ...
	 * @version 1.0.0
	 */
	PageInfo<OrderShowInfoDto> backCardPage(int pageNo, int pageSize, Map<String, Object> params);

	/**
	 * guo.jian updateOrderStateByOrderId(更新订单状态)
	 * 
	 * @param params
	 * @return int
	 * @version 1.0.0
	...
	/**
	 * guo.jian remainMoney(根据订单号返回用户vip卡剩余金额)
	 * 
	 * @param orderId
	 * @return float
	 * @version 1.0.0
	...
	/**
	 * guo.jian insertBackCardInfo(记录退卡流水号)
	 * 
	 * @param appCardBack
	 * @return int
	 * @version 1.0.0
	...
	/**
	 * guo.jian returnOrderDetailInfoByOrderId(根据订单编号返回订单详细信息)
	 * 
	 * @param order
	 ...
	 * @return
	 */
	BaseMsgInfo activeCard(String phone, String vipCardNo, String orderId) throws UnrecoverableKeyException,
	 ...
	 * @param response
	 */
	void exportcCounsumeInfoOfVipCard(HttpServletResponse response);
}

...
public class GloabConfig {
	...
	//系统用户
	public static final Integer BUSSNISS_USER = 3;//业务员
	public static final Integer SYSTEM_USER = 1;//系统用户
	public static final Integer SUPER_ADMIN = 2;//超级管理员
	...
	public static Object getConst(String field) {
		try {
			return GloabConfig.class.getField(field).get(null);
		} catch (Exception e) {
			// 异常代表无配置，这里什么也不做
		}
		return null;

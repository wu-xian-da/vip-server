			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					...
					<td><select class="easyui-combobox" name=imagetype data-options="panelHeight:'auto',editable:false" style="width: 155px;">
							...
							<option value="2" <c:if test="${appPicture.imagetype==1 }">selected="selected"</c:if> >用户APP合作按钮</option>
							<option value="1" <c:if test="${appPicture.imagetype==2 }">selected="selected"</c:if> >VIP卡权益轮播</option>

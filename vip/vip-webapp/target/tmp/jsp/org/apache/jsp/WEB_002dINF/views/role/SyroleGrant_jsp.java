...
public final class SyroleGrant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t$.post(sy.contextPath + '/role/grant', {\r\n");
      ...
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t$pjq.messager.alert('提示', result.msgBody, 'error');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t$('#tree').tree({\r\n");
      out.write("\t\t\turl : sy.contextPath + '/resource/tree',\r\n");
      ...
      out.write("\t\t\t\t$.post(sy.contextPath + '/resource/roleResources', {\r\n");
      out.write("\t\t\t\t\tid : $(':input[name=\"data.id\"]').val()\r\n");
      out.write("\t\t\t\t}, function(result) {\r\n");
      out.write("\t\t\t\t\tif (result) {\r\n");

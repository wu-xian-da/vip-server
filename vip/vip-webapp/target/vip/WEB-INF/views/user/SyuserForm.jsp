		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					...
					<th></th>
					<td><input name="photo" value="${user.photo }" readonly="readonly" style="display: none;" /> <img id="photo" src="" style="width: 200px; height: 200px;"></td>
				</tr>
			</table>
		</fieldset>
	</form>
